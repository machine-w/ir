class AddPropertyType < Mongoid::Migration
  def self.up
	...
	PropertyType.create(name: "整数",type_view: "integer", image_path: "fa-circle-blank",user_can_select: true)
	...
	PropertyType.create(name: "PDF文档",type_view: "pdf", image_path: "fa-file-alt",user_can_select: true)
	PropertyType.create(name: "图片",type_view: "picture", image_path: "fa-picture",user_can_select: true)
	PropertyType.create(name: "视频",type_view: "video", image_path: "fa-facetime-video",user_can_select: true)
	...
	PropertyType.create(name: "时间",type_view: "time", image_path: "fa-time",user_can_select: true)
	PropertyType.create(name: "数据表",type_view: "data_sheet", image_path: "fa-table",user_can_select: true)
	PropertyType.create(name: "列表",type_view: "array", image_path: "fa-list",user_can_select: true)
	PropertyType.create(name: "电子邮件",type_view: "email", image_path: "fa-envelope-alt",user_can_select: true)
	PropertyType.create(name: "链接",type_view: "link", image_path: "fa-link",user_can_select: true)
	PropertyType.create(name: "是否",type_view: "bool", image_path: "fa-ok",user_can_select: true)
  end
